...
//
// это OneSide роутер, но заменяю им orthogonal чтобы fallback остальных роутеров ссылался в него
joint.routers.orthogonal = function(vertices, opt, linkView) {
  ...
  if (
    ...
    // комментирование этой строчки делает линк с отступами от портов но гибкой междулинией. (в случае сломанного роута получается этакая Z с фиксированными горизонтальными линиями)
